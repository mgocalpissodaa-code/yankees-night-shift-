...
insert into public.central_request_types(name, symbol, color, sort_order) values
  ...
  ('早出希望', '早希', '#d97706', 30),
  ('遅出希望', '遅希', '#2563eb', 40),
  ('7:00〜12:00', '7-12', '#0891b2', 100),
  ('7:30〜12:30', '7:30-12:30', '#0e7490', 110),
  ('13:30〜19:00', '13:30-19', '#c2410c', 120),
  ('7:00〜16:00', '7-16', '#15803d', 130),
  ('7:30〜16:00', '7:30-16', '#0f766e', 135),
  ('8:00〜17:00', '8-17', '#16a34a', 140),
  ('9:00〜18:00', '9-18', '#2563eb', 150),
  ('10:00〜19:00', '10-19', '#7c3aed', 160),
  ('19:00〜翌7:00', '19-7', '#334155', 170),
  ('22:00〜翌8:00', '22-8', '#475569', 180),
  ('その他・勤務条件', '他', '#64748b', 900)
